...
const featuredPosts = [
  {
    ...
    title: "Mensyukuri Nikmat Islam",
    excerpt:
      "Allah SWT berfirman: فَمَن يُرِدِ اللَّهُ أَن يَهْدِيَهُ يَشْرَحْ صَدْرَهُ لِلْإِسْلَامِ — Barangsiapa dikehendaki Allah akan mendapat hidayah, Dia akan membukakan dadanya untuk Islam.",
  ...
  },
  {
    ...
    excerpt:
      "Sayyidina Ali bin Abi Thalib berkata: Dari sekian banyak nikmat dunia, cukuplah Islam sebagai nikmat bagimu. Dari sekian banyak kesibukan, cukuplah ketaatan sebagai kesibukan bagimu.",
    date: "6 April 2023",
    category: "Dakwah",
    verse: "Nashaihul 'Ibad",
    image: "/placeholder-2.jpg",
  },
  {
    id: 3,
    slug: "al-ukhuwah-al-islamiyah",
    title: "Al Ukhuwah Al Islamiyah",
    excerpt:
      "Jika umat Islam hanya memikirkan nasib masing-masing, di manakah ukhuwah Islamiyah? Di manakah universalitas Islam? Semangat nasionalisme telah merasuk lebih dalam daripada semangat Islam.",
    date: "30 Januari 2023",
    category: "Ukhuwah",
    verse: "QS. Al-An'am: 112",
